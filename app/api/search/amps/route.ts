...
export async function GET(request: NextRequest) {
  ...
  let builder = supabase
    .from("amp_models")
    .select("id, name, category, amp_type, tags, brand:amp_brands!brand_id(name)")
    .eq("is_active", true)
    .limit(20)
