...
values
  ...
  ('Harley Benton', 'SC-450 CS', 'guitar', 'solid-body electric', 'guitar', 'humbucker', null, null, array['single-cut','warm','sustain'], array['classic rock','budget rigs'], array['https://harleybenton.com'], 'Harley Benton SC-450 CS single cut humbucker sustain'),
  ('Schecter', 'Omen Extreme-6', 'guitar', 'solid-body electric', 'guitar', 'dual humbucker with coil split', null, null, array['modern','versatile','rock'], array['hard rock','metal'], array['https://www.schecterguitars.com'], 'Schecter Omen Extreme-6 dual humbucker coil split'),
  ('Fender', 'Player II Telecaster HH', 'guitar', 'solid-body electric', 'guitar', 'dual humbucker', null, null, array['tele','fat','modern'], array['rock','indie','session'], array['https://www.fender.com'], 'Fender Player II Telecaster HH dual humbucker'),
  ('ESP LTD', 'MH-10', 'guitar', 'super strat', 'guitar', 'dual humbucker', null, null, array['entry-level','metal','fast'], array['modern rock','metal'], array['https://www.espguitars.com'], 'ESP LTD MH-10 super strat metal'),
  ('Schecter', 'Demon-6', 'guitar', 'solid-body electric', 'guitar', 'active humbucker', null, null, array['aggressive','tight','modern'], array['metal','drop tuning'], array['https://www.schecterguitars.com'], 'Schecter Demon-6 active humbucker tight metal'),
  ('Rickenbacker', '330', 'guitar', 'semi-hollow electric', 'guitar', 'Hi-Gain single-coil', null, null, array['jangly','semi-hollow','bright'], array['jangle pop','classic rock'], array['https://www.rickenbacker.com'], 'Rickenbacker 330 jangly semi hollow'),
  ('Epiphone', 'SG Standard', 'guitar', 'solid-body electric', 'guitar', 'dual humbucker', null, null, array['lightweight','bite','classic'], array['classic rock','hard rock'], array['https://www.epiphone.com'], 'Epiphone SG Standard humbucker classic rock'),
  ('Generic', 'HSS Stratocaster', 'guitar', 'solid-body electric', 'guitar', 'HSS', null, null, array['versatile','balanced','modern'], array['covers','session','pop'], array[]::text[], 'Generic HSS Stratocaster versatile modern'),
  ('Schecter', 'C-1 Platinum', 'guitar', 'solid-body electric', 'guitar', 'active humbucker', null, null, array['sustain','modern','powerful'], array['metal','modern rock'], array['https://www.schecterguitars.com'], 'Schecter C-1 Platinum active sustain'),
  ('Jackson', 'Dinky', 'guitar', 'super strat', 'guitar', 'dual humbucker', null, null, array['fast','modern','cutting'], array['metal','hard rock'], array['https://www.jacksonguitars.com'], 'Jackson Dinky fast modern'),
  ('ESP LTD', 'EC-256', 'guitar', 'solid-body electric', 'guitar', 'dual humbucker', null, null, array['single-cut','focused','modern'], array['rock','metal'], array['https://www.espguitars.com'], 'ESP LTD EC-256 single cut modern'),
  ('Epiphone', 'ES-339 P-90 PRO', 'guitar', 'semi-hollow electric', 'guitar', 'dual P-90', null, null, array['airy','punchy','compact'], array['indie','classic rock'], array['https://www.epiphone.com'], 'Epiphone ES-339 P-90 PRO airy punchy'),
  ('Ibanez', 'GIO GRX70QA', 'guitar', 'solid-body electric', 'guitar', 'HSH', null, null, array['budget','versatile','modern'], array['practice','rock'], array['https://www.ibanez.com'], 'Ibanez GIO GRX70QA HSH versatile'),
  ('Yamaha', 'Pacifica 112V', 'guitar', 'solid-body electric', 'guitar', 'HSS', null, null, array['balanced','clean','versatile'], array['beginner','covers','session'], array['https://usa.yamaha.com'], 'Yamaha Pacifica 112V HSS versatile'),
  ('Yamaha', 'Pacifica 012', 'guitar', 'solid-body electric', 'guitar', 'HSS', null, null, array['entry-level','bright','flexible'], array['practice','beginner'], array['https://usa.yamaha.com'], 'Yamaha Pacifica 012 HSS beginner'),
  ('Gibson', 'ES-335', 'guitar', 'semi-hollow electric', 'guitar', 'dual humbucker', null, null, array['semi-hollow','warm','dynamic'], array['blues','rock','session'], array['https://www.gibson.com'], 'Gibson ES-335 semi hollow warm dynamic'),
  ('VOX', 'Mini GO 50', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-medium', array['portable','practice','versatile'], array['home practice','covers'], array['https://voxamps.com'], 'VOX Mini GO 50 portable modeling combo'),
  ('Line 6', 'Spider', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['modeling','effects','practice'], array['home practice','modern rock'], array['https://line6.com'], 'Line 6 Spider modeling combo effects'),
  ('Joyo', 'DC-15', 'amp', 'digital combo', 'guitar', null, 'modeling', 'low-medium', array['practice','compact','effects'], array['bedroom practice'], array['https://joyoaudio.com'], 'Joyo DC-15 digital combo practice'),
  ('Orange', 'Crush', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'medium', array['orange','dirty','simple'], array['rock','practice'], array['https://orangeamps.com'], 'Orange Crush solid state combo'),
  ('Yamaha', 'GA15II', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-medium', array['compact','clean','simple'], array['practice','beginner'], array['https://usa.yamaha.com'], 'Yamaha GA15II practice combo'),
  ('Orange', 'Crush 12', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-medium', array['compact','orange','punchy'], array['practice','small rooms'], array['https://orangeamps.com'], 'Orange Crush 12 compact combo'),
  ('Blackstar', 'ID:Core V4', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['stereo','modeling','effects'], array['practice','recording'], array['https://blackstaramps.com'], 'Blackstar ID Core V4 stereo modeling'),
  ('VOX', 'VT40X', 'amp', 'modeling combo', 'guitar', null, 'hybrid', 'low-high', array['valvetronix','flexible','tube-feel'], array['practice','covers'], array['https://voxamps.com'], 'VOX VT40X valvetronix modeling'),
  ('Fender', 'Mustang LT50', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['modeling','preset','practice'], array['home practice','small gigs'], array['https://www.fender.com'], 'Fender Mustang LT50 modeling combo'),
  ('Marshall', 'MG30FX', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'medium', array['marshall','effects','practice'], array['practice','rock'], array['https://marshall.com'], 'Marshall MG30FX solid state combo'),
  ('Fender', 'Mustang Micro', 'amp', 'headphone amp', 'guitar', null, 'modeling', 'low-high', array['portable','headphone','practice'], array['silent practice','travel'], array['https://www.fender.com'], 'Fender Mustang Micro headphone modeling'),
  ('Marshall', 'CODE 50', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['programmable','marshall','modeling'], array['practice','covers'], array['https://marshall.com'], 'Marshall CODE 50 modeling combo'),
  ('NUX', 'Mighty 60', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['budget','modeling','versatile'], array['practice','small gigs'], array['https://nuxaudio.com'], 'NUX Mighty 60 modeling combo'),
  ('Fender', 'Mustang GTX100', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['wi-fi','preset','stage-ready'], array['covers','live'], array['https://www.fender.com'], 'Fender Mustang GTX100 modeling combo'),
  ('Harley Benton', 'HB-40MFX', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['budget','effects','combo'], array['practice','beginner'], array['https://harleybenton.com'], 'Harley Benton HB-40MFX modeling combo'),
  ('Boss', 'Katana Gen 3 50W', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-high', array['katana','modern','versatile'], array['practice','gigs','covers'], array['https://www.boss.info'], 'Boss Katana Gen 3 50W combo'),
  ('Peavey', 'Vypyr 15', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['metal','modeling','effects'], array['practice','modern rock'], array['https://peavey.com'], 'Peavey Vypyr 15 modeling combo'),
  ('Fender', 'Frontman 20G', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-medium', array['simple','clean','practice'], array['beginner','practice'], array['https://www.fender.com'], 'Fender Frontman 20G practice combo'),
  ('VOX', 'Pathfinder 10', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-medium', array['compact','bright','practice'], array['practice','clean'], array['https://voxamps.com'], 'VOX Pathfinder 10 compact bright combo'),
  ('Roland', 'Cube-10GX', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['compact','high-gain','practice'], array['practice','recording'], array['https://www.roland.com'], 'Roland Cube-10GX compact modeling'),
  ('Fender', 'Mustang GTX 50', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['wireless','preset','versatile'], array['practice','covers'], array['https://www.fender.com'], 'Fender Mustang GTX 50 modeling combo'),
  ('Line 6', 'Spider V 20', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['digital','effects','cab-models'], array['practice','beginner'], array['https://line6.com'], 'Line 6 Spider V 20 digital modeling'),
  ('Marshall', 'DSL40CR', 'amp', 'tube combo', 'guitar', null, 'tube', 'high', array['british','valve','punchy'], array['rock','gigging'], array['https://marshall.com'], 'Marshall DSL40CR tube combo'),
  ('Fender', 'Champion 100', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-high', array['loud','versatile','clean'], array['covers','practice'], array['https://www.fender.com'], 'Fender Champion 100 combo'),
  ('Yamaha', 'THR', 'amp', 'desktop modeling amp', 'guitar', null, 'modeling', 'low-high', array['desktop','recording','hi-fi'], array['home practice','recording'], array['https://usa.yamaha.com'], 'Yamaha THR desktop modeling'),
  ('Boss', 'Katana', 'amp', 'solid-state combo', 'guitar', null, 'solid-state', 'low-high', array['popular','versatile','effects'], array['practice','gigs'], array['https://www.boss.info'], 'Boss Katana versatile combo'),
  ('Fender', 'Mustang LT25', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['compact','preset','practice'], array['practice','beginner'], array['https://www.fender.com'], 'Fender Mustang LT25 modeling combo'),
  ('Fender', 'Champion 20', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['compact','practice','versatile'], array['practice','beginner'], array['https://www.fender.com'], 'Fender Champion 20 modeling combo'),
  ('Marshall', 'CODE 25', 'amp', 'modeling combo', 'guitar', null, 'modeling', 'low-high', array['compact','marshall','programmable'], array['practice','recording'], array['https://marshall.com'], 'Marshall CODE 25 modeling combo'),
  ('Positive Grid', 'Spark', 'amp', 'desktop modeling amp', 'guitar', null, 'modeling', 'low-high', array['desktop','app','preset'], array['practice','song learning'], array['https://www.positivegrid.com'], 'Positive Grid Spark desktop modeling amp')
